define({ "api": [
  ...
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "http://localhost:3000/api/children/:child"
      }
    ],
    "permission": [
      {
  ...
  },
  {
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "date",
            "description": "<p>День рождения ребенка в формате d.m.Y. Обязательный.</p>"
          }
        ]
      },
      "examples": [
    ...
    "error": {
      "fields": {
        ...
        "Devices Limit Reached 403": [
          {
            "group": "Devices Limit Reached 403",
            "optional": false,
            "field": "BadRequest",
      ...
      "examples": [
        ...
        {
          "title": "Devices Limit Reached 403:",
        ...
        "Success 200": [
          {
            ...
            "optional": false,
            "field": "Success",
            "description": "<p>Новый ребенок и сообщение о его создании</p>"
          }
        ]
      },
      "examples": [
  ...
  },
  {
    "type": "patch",
    "url": "/api/children/:child",
    "title": "4. Обновить настройки и данные ребенка",
    "name": "UpdateChild",
    "group": "Child",
    "version": "1.0.0",
    "description": "<p>child - Id ребенка;</p>",
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "date",
            "description": "<p>День рождения ребенка в формате d.m.Y.</p>"
          },
          {
            "group": "Parameter",
            "type": "Boolean",
            "optional": false,
            "field": "block_all_apps",
            "description": "<p>Нужно ли блокировать все приложении.</p>"
          },
          {
            "group": "Parameter",
            "type": "Boolean",
            "optional": false,
            "field": "block_all_phones",
            "description": "<p>Нужно ли блокировать все телефоны.</p>"
          },
          {
            "group": "Parameter",
            "type": "Boolean",
            "optional": false,
            "field": "block_all_site",
            "description": "<p>Нужно ли блокировать все сайты.</p>"
          },
          {
            "group": "Parameter",
            "type": "Boolean",
            "optional": false,
            "field": "block_all_youtube",
            "description": "<p>Нужно ли блокировать все youtube каналы.</p>"
          }
        ]
      },
      "examples": [
        ...
        "Success 202": [
          {
            ...
            "optional": false,
            "field": "Success",
            "description": "<p>Ребенок и сообщение о обновлении его данных</p>"
          }
        ]
      },
      "examples": [
        ...
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "email",
            "description": "<p>Валидный email существующего пользователя. Обязательный.</p>"
          }
        ]
      },
      "examples": [
        ...
        "Success 202": [
          {
            ...
            "optional": false,
            "field": "Success",
            "description": "<p>Пользователь и сообщение о успешном обновлении данных пользователя</p>"
          }
        ]
      },
      "examples": [
        ...
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "token",
            "description": "<p>Шестизначный код для подтверждения email. Обязательный.</p>"
          }
        ]
      },
      "examples": [
  ...
  },
  {
    "type": "post",
    "url": "/api/youtube",
    "title": "2. Добавить youtube канал",
    "name": "PostYoutube",
    "group": "Youtube",
    "version": "1.0.0",
    "parameter": {
